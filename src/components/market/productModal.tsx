...
const createStyles = (colors: ThemeColors) =>
  StyleSheet.create({
    ...
    header: {
      ...
      backgroundColor: colors.background,
      borderBottomWidth: 1,
      borderBottomColor: colors.background === '#FFFFFF' ? '#f3f4f6' : 'rgba(255,255,255,0.1)',
    },
    dragIndicator: {
      alignSelf: 'center',
      width: 40,
    ...
    iconButton: {
      ...
      height: 36,
      borderRadius: 18,
      backgroundColor: colors.background === '#FFFFFF' ? '#f3f4f6' : 'rgba(255,255,255,0.1)',
      alignItems: 'center',
    ...
    priceSection: {
      backgroundColor: colors.background === '#FFFFFF' ? '#ecfdf5' : 'rgba(16, 185, 129, 0.15)',
      padding: 16,
      borderRadius: 12,
      borderLeftWidth: 4,
    ...
    exchangeSection: {
      backgroundColor: colors.background === '#FFFFFF' ? '#eff6ff' : 'rgba(59, 130, 246, 0.15)',
      padding: 16,
      borderRadius: 12,
      borderLeftWidth: 4,
    ...
    divider: {
      height: 1,
      backgroundColor: colors.background === '#FFFFFF' ? '#e5e7eb' : 'rgba(255,255,255,0.1)',
      marginVertical: 20,
      marginHorizontal: 20,
    },
    section: {
    ...
    actionCard: {
      ...
      gap: 8,
      borderWidth: 1,
      borderColor: colors.background === '#FFFFFF' ? '#e5e7eb' : 'rgba(255,255,255,0.1)',
    },
    reportCard: {
      borderColor: '#fecaca',
    },
    actionIcon: {
      ...
      height: 48,
      borderRadius: 24,
      backgroundColor: colors.background === '#FFFFFF' ? '#fff' : 'rgba(255,255,255,0.1)',
      alignItems: 'center',
      justifyContent: 'center',
    },
    actionEmoji: {
    ...
    footer: {
      ...
      backgroundColor: colors.background,
      borderTopWidth: 1,
      borderTopColor: colors.background === '#FFFFFF' ? '#f3f4f6' : 'rgba(255,255,255,0.1)',
    },
    tradeButton: {
      backgroundColor: '#10b981',
      borderRadius: 12,
